  ...
  },
  {
    ...
    copy: {
      ...
      ko: {
        ...
        definition:
          '젖산 발효(말로락틱 발효, MLF)는 날카로운 사과산을 더 부드러운 젖산으로 바꾸는 양조 과정입니다. 와인을 둥글게 만들고 버터나 크림 같은 느낌을 더하기도 합니다. 거의 모든 레드와인과 일부 화이트가 이 과정을 거칩니다.',
        whyItMatters:
  ...
  },
  {
    ...
    copy: {
      ...
      ko: {
        ...
        definition:
          '귀부(귀부병, 노블 롯)는 잘 익은 포도를 쪼그라뜨려 당과 풍미를 농축시키는 이로운 곰팡이(보트리티스 시네레아)입니다. 세계 최고의 스위트 와인을 만드는 데 쓰입니다. 조건이 나쁘면 같은 곰팡이가 해로운 회색 곰팡이가 됩니다.',
        whyItMatters:
  ...
  },
  {
    ...
    copy: {
      ...
      ko: {
        ...
        definition:
          '발효(알코올 발효)는 효모가 포도즙의 당을 알코올과 이산화탄소로 바꾸는 과정입니다. 포도즙을 와인으로 만드는 핵심 단계입니다. 당이 다 바뀌면 드라이해지고, 일찍 멈추면 단맛이 남습니다.',
        whyItMatters:
  ...
  },
  {
    ...
    copy: {
      ...
      ko: {
        ...
        short: '포도를 수확한 해.',
        definition:
          '빈티지는 포도를 수확한 해입니다. 라벨에 연도가 없으면 대개 여러 해의 와인을 섞은 것으로, 논빈티지(NV)라고 부릅니다. 라벨에 적힌 연도가 그해 재배 시기의 날씨를 알려주며, 좋은 해와 어려운 해가 와인의 품질과 스타일에 영향을 줍니다.',
        whyItMatters:
  ...
  },
  {
    ...
    copy: {
      ...
      ko: {
        ...
        definition:
          '리 숙성은 발효가 끝난 뒤 죽은 효모 찌꺼기와 와인을 함께 두는 것입니다. 이 찌꺼기를 영어로 리(lees), 우리말로 앙금이라고 합니다. 빵이나 비스킷 같은 향과 더 크리미한 질감을 더합니다. 샴페인과 일부 화이트와인에 흔합니다.',
        whyItMatters:
