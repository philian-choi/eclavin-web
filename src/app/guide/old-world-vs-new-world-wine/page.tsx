...
const GUIDE = getGuide('old-world-vs-new-world-wine')!;
...
export const metadata: Metadata = {
  ...
  description:
    'Old World vs New World wine explained for WSET students: how the labels, climates and taste differ, with the main regions on each side and key exam tips.',
    ...
    <main className="main-container">
      ...
      <article className={styles.page}>
        ...
        <p className={styles.subtitle}>
          The labels, styles, and regions behind wine’s biggest divide. Updated {formatDateEn(GUIDE.dateModified)}.
        </p>
