...
const GUIDE = getGuide('how-to-pass-wset-level-2')!;
...
export const metadata: Metadata = {
  ...
  description:
    'A practical study plan for WSET Level 2 in Wines: how much time you need, which topics to focus on, the common exam traps, and how to use practice questions.',
    ...
    <main className="main-container">
      ...
      <article className={styles.page}>
        ...
        <p className={styles.subtitle}>
          A practical study plan and the traps to watch for. Updated {formatDateEn(GUIDE.dateModified)}.
        </p>
        ...
        <section className={styles.cta}>
          ...
          <p>
            Start with all 100 free Level 2 practice questions, then practise with the Eclavin app’s
            2,000+ questions, mock exams, and a wrong-answer notebook that keeps resurfacing your weak
            spots.
          </p>
