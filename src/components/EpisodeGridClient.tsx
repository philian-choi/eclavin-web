...
function Level3Notice({ t }: { t: any }) {
  ...
  return (
    <div className="glass-notice animate-slide-up" style={{ textAlign: 'center', display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '1.5rem' }}>
      ...
      <a href="https://apps.apple.com/kr/app/eclavin-%EA%B5%AD%EC%A0%9C-%EC%99%80%EC%9D%B8-%EC%9E%90%EA%B2%A9%EC%A6%9D-%ED%95%A9%EA%B2%A9-%EC%B9%98%ED%8A%B8%ED%82%A4/id6757098139" target="_blank" rel="noopener noreferrer" className="app-store-btn-custom" onClick={() => posthog?.capture('AppStore_Click')}>
