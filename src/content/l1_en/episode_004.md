...
**Explanation**: The **Acidity (Acidity)** of a wine stimulates the salivary glands, causing your mouth to water. This acidity provides vibrancy to the fruit flavors and acts as the structural 'spine' of the wine. While tannin 'dries the mouth,' acidity 'waters the mouth.'
...
**[Trap]**: Do not confuse the sourness of vinegar with the acidity found in wine. Wine acidity is a healthy, natural freshness from the grapes, not an indication of spoilage.
**[Tip]**: In the exam, if you see the phrase **'Mouth-watering'**, choose **'Acidity'** as your answer without hesitation. The amount of saliva produced is the only standard criteria for determining the answer.
