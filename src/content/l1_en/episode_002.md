...
**[Trap]**: Thinking that "Tannins come from the pulp" is a common mistake. The pulp only contributes to the juice (water, sugar, acid), while tannins and color must come from the **skin**.
**[Tip]**: In the exam, if the words **'Sugar', 'Acid', and 'Water'** appear as a set, the answer is 100% **Pulp**. Conversely, if 'Color' or 'Tannin' are mentioned, choose **Skin**.
